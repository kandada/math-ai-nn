...
| 博客 | 地址 | 特色 |
|:----|:-----|:------|
| The Gradient | thegradientpub.com | 深度学习前沿解读 |
| Lil'Log (Lilian Weng) | lilianweng.github.io | 系统化技术博客 |
| Sebastian Ruder | ruder.io | NLP & 优化器深度分析 |
| Colah's Blog | colah.github.io | 可视化数学解释 |
