...
多通道卷积: C_in 个输入通道 × C_out 组滤波器 → C_out 个输出通道
...
```
平均池化示例：输入 [[3,1],[7,2]] → 输出 (3+1+7+2)/4 = 3.25
...
← [第 5 章 误差反向传播法](05-第5章-误差反向传播法.md) | [目录](README.md) | [第 7 章 训练技术](07-第7章-训练技术-优化器-正则化与损失函数.md) →
