...
![图 2-6：泰勒展开近似 sin(x) 函数。0 阶近似为常数，1 阶近似为线性，3 阶/5 阶/7 阶近似逐渐逼近原函数。](images/ch02/NN02_taylor_approx.png)
...
| 学习率 | 行为 | 结果 |
|:------|:-----|:-----|
| η 太小 | 每步几乎不动，路径极长 | 收敛极慢，永远走不到谷底 |
| η 适中 | 平稳下降，步长合理 | 快速收敛 ✅ |
| η 太大 | 越过最低点，来回震荡，甚至发散 | 无法收敛 ❌ |
...
![图 2-7：不同学习率的梯度下降对比。左：学习率过小，收敛极慢；中：学习率适中，快速收敛；右：学习率过大，震荡发散。](images/ch02/NN02_learning_rate_compare.png)

*图 2-7：学习率对比——过小则慢，过大则发散。*
...
![图 2-8：二维梯度下降路径。左：等高线图 + 路径；右：坐标值随迭代的变化。](images/ch02/NN02_gd_2d_path.png)
...
![图 2-9：线性回归拟合结果。散点为数据点，直线为拟合结果，虚线表示残差。](images/ch02/NN02_linear_regression.png)
